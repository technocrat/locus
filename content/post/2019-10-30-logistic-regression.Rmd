...
# HSL doesn't have code examples, but it does have figures and exercises
My plan is to worl those in `R` and to post the resu1ts here, with the scripts available on `github.`
1
# Also in preparation
