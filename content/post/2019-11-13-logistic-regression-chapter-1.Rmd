...
This figure is a scatterplot of coronary heart disease against age in the CHDAGE dataset.
    ...
    df <- readr::read_tsv("CHDAGE.txt")^[Assumes that CHDAGE is in your working directory.]
...
Exercise 1 uses the ICU dataset described in Section 1.6.1.

```{r, results="asis", echo = FALSE, warning=FALSE}
ICU <- readr::read_tsv("content/post/data/ICU/icu.txt")
```
